...
class CClassResolver : public CRefCountedObject
{
    public:
        ...
        virtual HRESULT ResolveEvents( TypeIndex::Value ClassType, CEventInformation** ppEvents ) = 0;
        virtual HRESULT ResolveEvents( const WCHAR* pTypeName, CEventInformation** ppEvents ) = 0;
