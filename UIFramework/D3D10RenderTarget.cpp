    ...
    )
{
    ...
    {
        D3D10_DEPTH_STENCIL_DESC depthDescription = { };

        depthDescription.DepthEnable = FALSE;
        depthDescription.DepthWriteMask = D3D10_DEPTH_WRITE_MASK_ALL;
        depthDescription.StencilEnable = FALSE;
        depthDescription.StencilReadMask = 0xFF;
        depthDescription.StencilWriteMask = 0xFF;
	    depthDescription.FrontFace.StencilFailOp = D3D10_STENCIL_OP_KEEP;
	    depthDescription.FrontFace.StencilDepthFailOp = D3D10_STENCIL_OP_INCR;
	    depthDescription.FrontFace.StencilPassOp = D3D10_STENCIL_OP_KEEP;
	    depthDescription.FrontFace.StencilFunc = D3D10_COMPARISON_ALWAYS;
	    depthDescription.BackFace.StencilFailOp = D3D10_STENCIL_OP_KEEP;
	    depthDescription.BackFace.StencilDepthFailOp = D3D10_STENCIL_OP_DECR;
	    depthDescription.BackFace.StencilPassOp = D3D10_STENCIL_OP_KEEP;
	    depthDescription.BackFace.StencilFunc = D3D10_COMPARISON_ALWAYS;
